...
final class NeonTests: XCTestCase {
    ...
    let testSuperview = UIView(frame: CGRect(x: 0, y: 0, width: 1000, height: 1000))
    let testAnchorView = UIView()
    let testAnchorView2 = UIView()
    let testSiblingView = UIView()
    let testSiblingView2 = UIView()
    let testSiblingView3 = UIView()
    let testSiblingView4 = UIView()
